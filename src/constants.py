...
tips = (
    "We have an awesome support server:\ndiscord.gg/qXNWfdJpFd",
    "You can set custom reactions for tourneys & scrims with Wolf Pro.",
    "I like your face : )",  # I really do
    "You can add a role to multiple users with `role @role @user @user2...` command.",
    "Wolf can detect and verify youtube/insta/loco,etc. screenshots (`ssverify` cmd).",
    "You can buy Wolf Pro for 29INR only at <https://wolfbot.xyz/premium>",
    ...
    "With Wolf Pro you can set custom DM message.",
...
async def remind_premium(ctx):
    ...
    _e.description = (
        f"Your Wolf Premium subscription is ending {discord_timestamp(guild.premium_end_time)}\n\n"
